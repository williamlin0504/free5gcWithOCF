...
var ConsumerOCFN1N2MessageSubscribeRequsetTable = make(map[string]*models.UeN1N2InfoSubscriptionCreateData)

func init() {
	ConsumerOCFN1N2MessageSubscribeRequsetTable[UeN1N2InfoSubsriptionCreateData] = &models.UeN1N2InfoSubscriptionCreateData{
