...
const (
	...
	ServiceName_NCHF_AM_POLICY_CONTROL    ServiceName = "nchf-am-policy-control"
	ServiceName_NCHF_SMPOLICYCONTROL      ServiceName = "nchf-smpolicycontrol"
	ServiceName_NCHF_POLICYAUTHORIZATION  ServiceName = "nchf-policyauthorization"
	ServiceName_NCHF_BDTPOLICYCONTROL     ServiceName = "nchf-bdtpolicycontrol"
	ServiceName_NCHF_EVENTEXPOSURE        ServiceName = "nchf-eventexposure"
	ServiceName_NCHF_UE_POLICY_CONTROL    ServiceName = "nchf-ue-policy-control"
