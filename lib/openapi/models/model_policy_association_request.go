...
type PolicyAssociationRequest struct {
	...
	// If the NF service consumer is an OCF, it should provide the name of a service produced by the OCF that makes use of information received within the Npcf_AMPolicyControl_UpdateNotify service operation.
