...
type PolicyAssociationRequest struct {
	...
	// If the NF service consumer is an AMF, it should provide the name of a service produced by the AMF that makes use of information received within the Nccf_AMPolicyControl_UpdateNotify service operation.
