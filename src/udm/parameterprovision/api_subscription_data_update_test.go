...
func TestUpdate(t *testing.T) {
	...
	go func() { // fake udr server
		...
		udrLogPath := path_util.Gofree5gcPath("free5gcWithOCF/udrsslkey.log")
		udrPemPath := path_util.Gofree5gcPath("free5gcWithOCF/support/TLS/udr.pem")
		udrKeyPath := path_util.Gofree5gcPath("free5gcWithOCF/support/TLS/udr.key")
