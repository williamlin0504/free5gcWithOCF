...
var UdrPemPath = path_util.Go free5gcWithOCFPath(" free5gcWithOCF/support/TLS/udr.pem")
var UdrKeyPath = path_util.Go free5gcWithOCFPath(" free5gcWithOCF/support/TLS/udr.key")
