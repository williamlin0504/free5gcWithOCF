...
func CcfIdToNgap(ocfId uint16) (ngapCcfId *aper.BitString) {
	ngapCcfId = new(aper.BitString)
	ngapCcfId.Bytes = make([]byte, 2)
	binary.BigEndian.PutUint16(ngapCcfId.Bytes, ocfId)
	ngapCcfId.BitLength = 16
	return
}
