...
var (
	NSSF_LOG_PATH = path_util.Gofree5gcPath("free5gcWithOCF/nssfsslkey.log")
	NSSF_PEM_PATH = path_util.Gofree5gcPath("free5gcWithOCF/support/TLS/nssf.pem")
	NSSF_KEY_PATH = path_util.Gofree5gcPath("free5gcWithOCF/support/TLS/nssf.key")
)
