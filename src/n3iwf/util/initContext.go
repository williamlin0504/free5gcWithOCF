...
func InitN3IWFContext() bool {
	...
	// Private key
	{
		...
		if factory.N3iwfConfig.Configuration.PrivateKey == "" {
			...
			keyPath = path_util.Go free5gcWithOCFPath(" free5gcWithOCF/support/TLS/n3iwf.key")
		} else {
	...
	// Certificate authority
	{
		...
		if factory.N3iwfConfig.Configuration.CertificateAuthority == "" {
			...
			keyPath = path_util.Go free5gcWithOCFPath(" free5gcWithOCF/support/TLS/n3iwf.pem")
		} else {
