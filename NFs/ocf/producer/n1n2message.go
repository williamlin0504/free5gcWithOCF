...
func N1N2MessageTransferProcedure(ueContextID string, reqUri string,
	...
	if ue.CmConnect(anType) {
		...
		if n2Info != nil {
			...
			case models.NgapIeType_PDU_RES_SETUP_REQ:
				ue.ProducerLog.Debugln("OCF Transfer NGAP PDU Session Resource Setup Request from SMF")
			...
			case models.NgapIeType_PDU_RES_MOD_REQ:
				ue.ProducerLog.Debugln("OCF Transfer NGAP PDU Session Resource Modify Request from SMF")
			...
			case models.NgapIeType_PDU_RES_REL_CMD:
				ue.ProducerLog.Debugln("OCF Transfer NGAP PDU Session Resource Release Command from SMF")
	...
	// in subclause 5.2.2.3.1.2 of TS29519
	if anType == models.AccessType__3_GPP_ACCESS {
		...
		// access type is Non-3GPP access)in subclause 5.2.2.3.1.2 of TS29519
