...
func InitOcfContext(context *context.OCFContext) {
	...
	context.RegisterIPv4 = factory.OCF_DEFAULT_IPV4 // default localhost
	context.SBIPort = factory.OCF_DEFAULT_PORT_INT  // default port
	if sbi != nil {
		if sbi.RegisterIPv4 != "" {
	...
	if configuration.NrfUri != "" {
		...
		context.NrfUri = factory.OCF_DEFAULT_NRFURI
	}
