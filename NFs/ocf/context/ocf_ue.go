...
type OcfUe struct {
	/* the OCF which serving this OcfUe now */
	servingOCF *OCFContext // never nil
...
func (ue *OcfUe) ServingOCF() *OCFContext {
	return ue.servingOCF
}
...
func (ue *OcfUe) StoreSmContext(pduSessionID int32, smContext *SmContext) {
	ue.SmContextList.Store(pduSessionID, smContext)
}

func (ue *OcfUe) SmContextFindByPDUSessionID(pduSessionID int32) (*SmContext, bool) {
