...
var (
	ocfContext                                                = OCFContext{}
	tmsiGenerator                    *idgenerator.IDGenerator = nil
	ocfUeNGAPIDGenerator             *idgenerator.IDGenerator = nil
	ocfStatusSubscriptionIDGenerator *idgenerator.IDGenerator = nil
)
...
func init() {
	...
	OCF_Self().PlmnSupportList = make([]factory.PlmnSupportItem, 0, MaxNumOfPLMNs)
...
func (context *OCFContext) InPlmnSupportList(snssai models.Snssai) bool {
