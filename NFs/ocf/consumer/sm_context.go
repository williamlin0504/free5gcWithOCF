...
func SelectSmf(
	ue *ocf_context.OcfUe,
	anType models.AccessType,
	pduSessionID int32,
	snssai models.Snssai,
	dnn string) (*ocf_context.SmContext, uint8, error) {
	var (
		smfID  string
		smfUri string
	)
	...
	nrfUri := ue.ServingOCF().NrfUri // default NRF URI is pre-configured by OCF
		...
		if ue.NssfUri == "" {
			...
			for {
				if err := SearchNssfNSSelectionInstance(ue, nrfUri, models.NfType_NSSF,
					...
					ue.GmmLog.Errorf("OCF can not select an NSSF Instance by NRF[Error: %+v]", err)
	...
	smContext := ocf_context.NewSmContext(pduSessionID)
	...
	result, err := SendSearchNFInstances(nrfUri, models.NfType_SMF, models.NfType_OCF, &param)
	if err != nil {
		return nil, nasMessage.Cause5GMMPayloadWasNotForwarded, err
	}
...
func SendCreateSmContextRequest(ue *ocf_context.OcfUe, smContext *ocf_context.SmContext,
...
func buildCreateSmContextRequest(ue *ocf_context.OcfUe, smContext *ocf_context.SmContext,
...
func SendUpdateSmContextActivateUpCnxState(
	ue *ocf_context.OcfUe, smContext *ocf_context.SmContext, accessType models.AccessType) (
	*models.UpdateSmContextResponse, *models.UpdateSmContextErrorResponse, *models.ProblemDetails, error) {
	...
	if ladn, ok := ue.ServingOCF().LadnPool[smContext.Dnn()]; ok {
...
func SendUpdateSmContextDeactivateUpCnxState(ue *ocf_context.OcfUe,
	smContext *ocf_context.SmContext, cause ocf_context.CauseAll) (
	*models.UpdateSmContextResponse, *models.UpdateSmContextErrorResponse, *models.ProblemDetails, error) {
	updateData := models.SmContextUpdateData{}
...
func SendUpdateSmContextChangeAccessType(ue *ocf_context.OcfUe,
	smContext *ocf_context.SmContext, anTypeCanBeChanged bool) (
	*models.UpdateSmContextResponse, *models.UpdateSmContextErrorResponse, *models.ProblemDetails, error) {
	updateData := models.SmContextUpdateData{}
...
func SendUpdateSmContextN2Info(
	ue *ocf_context.OcfUe, smContext *ocf_context.SmContext, n2SmType models.N2SmInfoType, N2SmInfo []byte) (
	*models.UpdateSmContextResponse, *models.UpdateSmContextErrorResponse, *models.ProblemDetails, error) {
	updateData := models.SmContextUpdateData{}
...
func SendUpdateSmContextN2HandoverPreparing(
	ue *ocf_context.OcfUe,
	smContext *ocf_context.SmContext,
	...
	*models.UpdateSmContextResponse, *models.UpdateSmContextErrorResponse, *models.ProblemDetails, error) {
	...
	if ocfid != "" {
		updateData.TargetServingNfId = ocfid
	}
	return SendUpdateSmContextRequest(smContext, updateData, nil, N2SmInfo)
}
...
func SendUpdateSmContextN2HandoverComplete(
	ue *ocf_context.OcfUe, smContext *ocf_context.SmContext, ocfid string, guami *models.Guami) (
	*models.UpdateSmContextResponse, *models.UpdateSmContextErrorResponse, *models.ProblemDetails, error) {
	updateData := models.SmContextUpdateData{}
	updateData.HoState = models.HoState_COMPLETED
	if ocfid != "" {
		updateData.ServingNfId = ocfid
...
func SendUpdateSmContextN2HandoverCanceled(ue *ocf_context.OcfUe,
	smContext *ocf_context.SmContext, cause ocf_context.CauseAll) (
	*models.UpdateSmContextResponse, *models.UpdateSmContextErrorResponse, *models.ProblemDetails, error) {
	updateData := models.SmContextUpdateData{}
...
func SendUpdateSmContextHandoverBetweenAccessType(
	ue *ocf_context.OcfUe, smContext *ocf_context.SmContext, targetAccessType models.AccessType, N1SmMsg []byte) (
	*models.UpdateSmContextResponse, *models.UpdateSmContextErrorResponse, *models.ProblemDetails, error) {
	updateData := models.SmContextUpdateData{}
...
func SendUpdateSmContextHandoverBetweenOCF(
	ue *ocf_context.OcfUe, smContext *ocf_context.SmContext, ocfid string, guami *models.Guami, activate bool) (
	*models.UpdateSmContextResponse, *models.UpdateSmContextErrorResponse, *models.ProblemDetails, error) {
	updateData := models.SmContextUpdateData{}
	updateData.ServingNfId = ocfid
	updateData.ServingNetwork = guami.PlmnId
...
func SendUpdateSmContextRequest(smContext *ocf_context.SmContext,
...
func SendReleaseSmContextRequest(ue *ocf_context.OcfUe, smContext *ocf_context.SmContext,
	cause *ocf_context.CauseAll, n2SmInfoType models.N2SmInfoType,
